...
*****************************
*/
CONST(life_save_civ,TRUE); //Save weapons for civs?
CONST(life_save_yinv,TRUE); //Save Y-Inventory for players?
...
life_nottoofast = time;/////////////////////////////////////////////////////// nottoofast ««ôia
...
switch (playerSide) do {
	case west: {
		...
		life_paycheck = 10069; //Paycheck Amount
	};

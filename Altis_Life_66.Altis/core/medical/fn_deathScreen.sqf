...
waitUntil {
	...
	_medicsNear ctrlSetText format["Médsico próximo: Não",_nearby]; } else {   _medicsNear ctrlSetText format["Médico mais próximo: %1m",[(round _nearby)] call life_fnc_numberText];};  sleep 1;  (isNull (findDisplay 7300))};
	sleep 1;

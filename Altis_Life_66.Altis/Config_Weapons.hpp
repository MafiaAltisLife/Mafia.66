...
class WeaponShops {
    ...
    class rebel {
        ...
        items[] = {
            ...
            { "srifle_EBR_F", "", 100000, 50000 },
            { "LMG_Mk200_F", "", 150000, 75000 },
            { "LMG_Zafir_F", "", 200000, 100000 },
            { "arifle_Katiba_F", "", 100000, 50000 },
            { "arifle_Katiba_C_F", "", 100000, 50000 },
            { "arifle_Mk20_F", "", 100000, 50000 },
            { "arifle_MXC_F", "", 250000, 125000 },
            { "arifle_MX_SW_F", "", 280000, 140000 },
            { "arifle_MXM_F", "", 250000, 125000 },
            { "arifle_MXC_Black_F", "", 250000, 125000 },
            { "arifle_MX_Black_F", "", 250000, 125000 },
            { "arifle_MXM_Black_F", "", 250000, 125000 },
            { "arifle_TRG21_F", "", 100000, 50000 },
            { "srifle_DMR_02_F", "", 300000, 150000 },
            { "srifle_DMR_02_camo_F", "", 300000, 150000 },
            { "srifle_DMR_02_sniper_F", "", 300000, 150000 },
            { "srifle_DMR_03_F", "", 320000, 160000 },
            { "srifle_DMR_03_khaki_F", "", 320000, 160000 },
            { "srifle_DMR_03_tan_F", "", 320000, 160000 },
            { "srifle_DMR_03_multicam_F", "", 320000, 160000 },
            { "srifle_DMR_03_woodland_F", "", 320000, 160000 },
            { "srifle_DMR_04_F", "", 550000, 275000 },
            { "srifle_DMR_04_Tan_F", "", 550000, 275000 },
            { "srifle_DMR_05_blk_F", "", 400000, 200000 },
            { "srifle_DMR_05_hex_F", "", 400000, 200000 },
            { "srifle_DMR_05_tan_f", "", 400000, 200000},
            { "srifle_DMR_06_camo_F", "", 350000, 175000},
            { "srifle_DMR_06_olive_F", "", 350000, 175000},

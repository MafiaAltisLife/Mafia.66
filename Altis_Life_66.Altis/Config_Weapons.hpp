...
class WeaponShops {
    ...
    class rebel {
        ...
        items[] = {
            ...
            { "SMG_01_F", "", 30000, 15000 },
            { "SMG_02_F", "", 30000, 15000 },
            { "srifle_DMR_01_F", "", 320000, 160000 },
            { "srifle_EBR_F", "", 300000, 150000 },
            { "LMG_Mk200_F", "", 350000, 175000 },
            { "LMG_Zafir_F", "", 320000, 160000 },
            { "arifle_Katiba_F", "", 150000, 75000 },
            { "arifle_Katiba_C_F", "", 155000, 75600 },
            { "arifle_Mk20_F", "", 120000, 60000 },
            { "arifle_MXC_F", "", 280000, 140000 },
            { "arifle_MX_SW_F", "", 300000, 140000 },
            { "arifle_MXM_F", "", 290000, 145000 },
            { "arifle_MXC_Black_F", "", 280000, 140000 },
            { "arifle_MX_Black_F", "", 290000, 145000 },
            { "arifle_MXM_Black_F", "", 290000, 145000 },
            { "arifle_TRG21_F", "", 130000, 115000 },
            { "srifle_DMR_02_F", "", 500000, 250000 },
            { "srifle_DMR_02_camo_F", "", 500000, 250000 },
            { "srifle_DMR_02_sniper_F", "", 500000, 100000 },
            { "srifle_DMR_03_F", "", 380000, 145000 },
            { "srifle_DMR_03_khaki_F", "", 380000, 145000 },
            { "srifle_DMR_03_tan_F", "", 380000, 145000 },
            { "srifle_DMR_03_multicam_F", "", 380000, 145000 },
            { "srifle_DMR_03_woodland_F", "", 380000, 145000 },
            { "srifle_DMR_04_F", "", 700000, 350000 },
            { "srifle_DMR_04_Tan_F", "", 700000, 350000 },
            { "srifle_DMR_05_blk_F", "", 600000, 300000 },
            { "srifle_DMR_05_hex_F", "", 600000, 300000 },
            { "srifle_DMR_05_tan_f", "", 600000, 300000},
            { "srifle_DMR_06_camo_F", "", 390000, 195000},
            { "srifle_DMR_06_olive_F", "", 390000, 195000},
    ...
    class gang {
        ...
        items[] = {
            ...
            { "SMG_01_F", "", 30000, 15000 },
            { "SMG_02_F", "", 30000, 15000 },
            { "arifle_MXC_F", "", 270000, 130000 },
            { "arifle_MX_SW_F", "", 290000, 130000 },
            { "arifle_MXM_F", "", 280000, 130000 },
